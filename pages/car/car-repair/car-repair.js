...
Page({
  ...
  onSearch() {
    ...
    if (this.data.pageNum == 1)
      this.data.result = []
    request({
      url: '/applets/vehicle_info/findRepairOrdersByPage',
      data: { orderNo: this.data.value, vin: wx.getStorageSync("vin"), currenPage: this.data.pageNum, pageSize: this.data.pageSize },
      method: 'get'
    },
      res => {
